...
!function(e) {
  ...
  var i = function() {
    ...
    B: "brandLabBeltB",
    C: "brandLabBeltC"
  }, v = "brandlab", g = v + "__content", w = v + "__content--page2", m = "disabled", y = function() {
    function e(n) {
      var a = this;
      ...
      }), delete window.BGMP.brandLabTeases) : console.log("no teases detected", window.BGMP);
    }
    return i(e, [ {
      key: "addTease",
      value: function(e, n) {
      ...
      value: function(e, n, a) {
        ...
        this._tooltipHooverEvents(), n.on("click", function(t) {
          t.preventDefault(), e.removeClass(w), n.addClass(m), a.removeClass(m);
        }), a.on("click", function(r) {
          r.preventDefault(), e.addClass(w), n.removeClass(m), a.addClass(m);
