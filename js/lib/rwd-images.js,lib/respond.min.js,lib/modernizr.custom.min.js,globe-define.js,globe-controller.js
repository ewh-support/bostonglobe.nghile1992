	...
	*/
	...
	globe.load.style = function( href, media ){
		...
		var lk			= doc.createElement( "link" ),
            ...
            if (globe && globe.version) {
                lk.href += '?v=' + globe.version;
            }
...
globe.analytics = {
	...
	globe.assets = {
		js: {
			...
			debouncedResize: "lib/jquery.debouncedresize.js",
			...
			json2: "lib/json2.js",
      lodashCustom: "lib/lo-dash-custom-2.4.1.js",
			mbox: "lib/mbox.js",
			...
			masthead: "globe-masthead.js,globe-sticky-masthead.js",
			article: "dist/inline-newsletter.js,globe-article.js,globe-share-tools.js,globe-sticky-tools.js",
			...
			toolbar: "globe-toolbar.js",
			serp: "globe-serp.js",
			regi: "globe-regi.js",
			videoplayer: "lib/brightcoveplayer.js,lib/videojs.ima3.min.js,globe-brightcove-player.js",
			...
			analytics: "dist/bglobesubs.js,globe-analytics.js",
      slick: "lib/slick.min.js",
      featstrip: "globe-feature-strip.js",
			fixedSticky: "lib/fixedsticky.js",
			positionSticky: "lib/sticky.js",
			sponCon: "globe-sponcon.js",
			backboneEntry: "backbone/application.js",
			backboneArticle: "backbone/modules/article/article.js"
		},
		css: {
	...
	var jsToLoad = [
			...
			globe.assets.js.debouncedResize,
	...
	globe.bodyready(function(){
		...
		var gallery			=	globe.tmplType		=== "gallery",
			crossword       =   typeof globe.section === "string" ? globe.section === "crossword": globe.tmplType === "crossword",
		...
		if( touch ) {
			jsToLoad.unshift( globe.assets.js.touch );
		}
		...
		if ( typeof Backbone !== 'undefined') {
			jsToLoad.push( globe.assets.js.backboneEntry);
			jsToLoad.push( globe.assets.js.backboneArticle);
		}
		...
		if ( document.getElementById("newsletter-signup")) {
			cssToLoad.push( "globe-newsletter.css" );
		}
		...
		// If there is a brightcove video on the page, load it's js and css
		if ( document.getElementById( "video" ) ) {
			jsToLoad.push( globe.assets.js.videoplayer );
			cssToLoad.push( "videojs.css" );
		}

		// Scribble Live

		if ( document.getElementById( "scribblelive" ) ) {
			cssToLoad.push( "globe-scribble-live.css" );
			jsToLoad.push( "lib/scribble-live-scripts.js" );
			jsToLoad.push( "globe-scribble-live-event.js" );
		}
        ...
        if ( document.getElementById( "sponcon" ) ) {
        	jsToLoad.push(globe.assets.js.sponCon);
        }

    var bracketContainer = document.getElementById( "bracket-container");
    if ( bracketContainer ) {
    		jsToLoad.push('lib/jQuery.XDomainRequest.js')
    		var bracketType;
    		if (bracketContainer.dataset) { // IE9 LOL
				bracketType = bracketContainer.dataset.bracketType;
			} else {
				bracketType = bracketContainer.getAttribute("data-bracket-type");
			}
			var suffix = bracketType?'-'+bracketType:'';
            cssToLoad.push('brackets/globe-brackets'+suffix+'.css');
            jsToLoad.push('brackets/globe-brackets'+suffix+'.js');
        }
